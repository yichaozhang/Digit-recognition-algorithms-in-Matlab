...
%%% Date:           2015-09-04
%%% Description:
  % In this function, cost function is set as: C=-(ylna+(1-y)ln(1-a)) (cross-
...
function [cost_value_average,BP_net,test_info] = BP_V2_train_cost_entropy(digit_dimension,BP_parameter)

global main_folder  
global BP_net_V2_str trn_data_num test_data_num 

file_to_open_BP_net = [main_folder,'49_data\',BP_net_V2_str];
...
for ii = 1:data_selec_per_time                                              % BP iteration begins
  ...
  %%% 2.7 Calculate the cost value of this train data, and add it to the total cost for this set of train data. 
    ...
    cost_value_1 = -1* sum( label_input_1.*log(output_activation)+(1-label_input_1).*log(1-output_activation) );
...
file_to_save = [main_folder,'49_data\',BP_net_V2_str];
